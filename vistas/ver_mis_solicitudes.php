...
<body class="bg-gray-900 text-white p-6">
  ...
  <div class="max-w-3xl mx-auto">
    ...
    <div class="mt-4 lg:mt-0 mb-4">
        <input type="text" id="filtro-busqueda" placeholder="Buscar por cliente, motivo, pago..." class="bg-gray-800 text-white p-2 text-sm sm:text-base rounded border border-gray-600 w-full sm:w-72">
    </div>
